...
const emptyArray = [ ];  // By array literal
var arrayname=new Array();  // By creating instance of Array directly (using new keyword)
arrayname[0] = '23';
var emp=new Array("Jai","Vijay","Smith");   // Array constructor (using new keyword)
